          ...
          <div className="flex flex-col gap-4 md:pl-10">
            ...
            <div className="mt-4">
              ...
              <ul className="space-y-1 text-gray-400">
                <li><strong>Leaf:</strong> {plant.characteristics?.leafShape}</li>
                <li><strong>Type:</strong> {plant.characteristics?.growthType}</li>
                <li><strong>Size:</strong> {plant.characteristics?.size}</li>
              </ul>
            </div>
